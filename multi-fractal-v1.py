...
class FractalGUI:
    def __init__(self):
        ...
        mng.resize(800, 600)  # Set the window size
    ...
    def draw_mandelbrot(self):
        self.animate_fractal(-0.743643887037151, 0.13182590420533, 1.5, mandelbrot, 'plasma')
    ...
    def draw_burning_ship(self):
        ...
        self.animate_fractal(-1.8, -0.08, 1.5, burning_ship, 'inferno')
    ...
    def draw_tricorn(self):
        self.animate_fractal(-0.743643887037151, 0.13182590420533, 1.5, tricorn, 'twilight_shifted')

    def draw_celtic_mandelbrot(self):
        self.animate_fractal(-0.743643887037151, 0.13182590420533, 1.5, celtic_mandelbrot, 'cividis')

    def animate_fractal(self, center_x, center_y, zoom_factor, fractal_func, cmap):
        num_frames = 30
        plt.clf()
